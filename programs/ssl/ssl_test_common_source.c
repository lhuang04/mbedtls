                        ...
                        mbedtls_tls_prf_types tls_prf_type )
{
    ...
    switch( secret_type )
    {
        ...
        case MBEDTLS_SSL_KEY_EXPORT_TLS13_CLIENT_HANDSHAKE_TRAFFIC_SECRET:
            ...
            break;
        case MBEDTLS_SSL_KEY_EXPORT_TLS13_SERVER_HANDSHAKE_TRAFFIC_SECRET:
            strcpy(label, "SERVER_HANDSHAKE_TRAFFIC_SECRET ");
            break;
        case MBEDTLS_SSL_KEY_EXPORT_TLS13_CLIENT_APPLICATION_TRAFFIC_SECRET:
            strcpy(label, "CLIENT_TRAFFIC_SECRET_0 ");
            break;
        case MBEDTLS_SSL_KEY_EXPORT_TLS13_SERVER_APPLICATION_TRAFFIC_SECRET:
